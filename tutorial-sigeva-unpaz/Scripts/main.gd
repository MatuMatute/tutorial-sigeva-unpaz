...
func _draw() -> void:
	...
	draw_circle(orange_circle_position, 160.0, Color.LIGHT_SALMON);
	draw_circle(blue_circle_position, 160.0, Color.SKY_BLUE);
	draw_circle(lily_circle_position, 160.0, Color.MEDIUM_ORCHID);
	draw_circle(aquamarine_circle_position, 160.0, Color.AQUAMARINE);
